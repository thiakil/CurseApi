...
public class ArrayOfFuzzyMatch implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ArrayOfFuzzyMatch", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ArrayOfFuzzyMatch", xmlWriter);
			}
		}

		if (localFuzzyMatchTracker) {
			if (localFuzzyMatch != null) {
				for (int i = 0; i < localFuzzyMatch.length; i++) {
					if (localFuzzyMatch[i] != null) {
						localFuzzyMatch[i].serialize(new QName(
								"Curse.AddOns", "FuzzyMatch"), xmlWriter);
					} else {
						writeStartElement(null, "Curse.AddOns", "FuzzyMatch",
								xmlWriter);
				...
				writeStartElement(null, "Curse.AddOns", "FuzzyMatch", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfFuzzyMatch parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfFuzzyMatch".equals(type)) {
							...
							return (ArrayOfFuzzyMatch) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName("Curse.AddOns",
								"FuzzyMatch").equals(reader.getName())) {
						...
						if (reader.isEndElement()) {
							...
							if (new QName("Curse.AddOns",
								...
								if ("true".equals(nillableValue) ||
									...
									list1.add(FuzzyMatch.Factory.parse(
											reader));
								}
							} else {
								loopDone1 = true;
					...
					object.setFuzzyMatch((FuzzyMatch[]) ConverterUtil.convertToArray(
							FuzzyMatch.class, list1));
