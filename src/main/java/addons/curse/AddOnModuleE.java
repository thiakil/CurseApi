...
/**
 * AddOnModuleE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class AddOnModuleE implements ADBBean {
	public static final QName MY_QNAME = new QName("Curse.AddOns", "AddOnModule", "ns4");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localAddOnModule == null) {
			...
			writeStartElement(null, namespace, "AddOnModule", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localAddOnModule.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static AddOnModuleE parse(XMLStreamReader reader) throws Exception {
			AddOnModuleE object = new AddOnModuleE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("Curse.AddOns", "AddOnModule").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setAddOnModule(null);
								reader.next();
							} else {
								object.setAddOnModule(AddOnModule.Factory.parse(reader));
							}
