...
/**
 * FuzzyMatch bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class FuzzyMatch implements ADBBean {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":FuzzyMatch", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FuzzyMatch", xmlWriter);
			}
		}

		if (localFileTracker) {
			if (localFile == null) {
				writeStartElement(null, "Curse.AddOns", "File", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static FuzzyMatch parse(XMLStreamReader reader) throws Exception {
			FuzzyMatch object = new FuzzyMatch();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"FuzzyMatch".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (FuzzyMatch) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
