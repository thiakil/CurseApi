...
public class FuzzyMatch implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":FuzzyMatch", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"FuzzyMatch", xmlWriter);
			}
		}
		...
		if (localFileTracker) {
			if (localFile == null) {
				...
				localFile.serialize(new QName(
						"Curse.AddOns", "File"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static FuzzyMatch parse(XMLStreamReader reader)
				throws Exception {
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"FuzzyMatch".equals(type)) {
							...
							return (FuzzyMatch) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName("Curse.AddOns", "File").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setFile(AddOnFile.Factory.parse(
								reader));
