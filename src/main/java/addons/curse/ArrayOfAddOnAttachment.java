...
public class ArrayOfAddOnAttachment implements ADBBean {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ArrayOfAddOnAttachment", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfAddOnAttachment", xmlWriter);
			}
		}
	...
	public static void serialize(final QName parentQName, XMLStreamWriter xmlWriter, List<AddOnAttachment> list) throws XMLStreamException {
	...
	public static class Factory {
		 ...
		 */
		public static List<AddOnAttachment> parse(XMLStreamReader reader) throws Exception {
			int event;
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfAddOnAttachment".equals(type)) {
							...
							return (List<AddOnAttachment>) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
