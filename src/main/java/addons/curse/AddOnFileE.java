...
/**
 * AddOnFileE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class AddOnFileE implements ADBBean {
	public static final QName MY_QNAME = new QName("Curse.AddOns", "AddOnFile", "ns4");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localAddOnFile == null) {
			...
			writeStartElement(null, namespace, "AddOnFile", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localAddOnFile.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static AddOnFileE parse(XMLStreamReader reader) throws Exception {
			AddOnFileE object = new AddOnFileE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("Curse.AddOns", "AddOnFile").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setAddOnFile(null);
								reader.next();
							} else {
								object.setAddOnFile(AddOnFile.Factory.parse(reader));
							}
