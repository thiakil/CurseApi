...
public class AddOnAuthor implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":AddOnAuthor", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"AddOnAuthor", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static AddOnAuthor parse(XMLStreamReader reader)
				throws Exception {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"AddOnAuthor".equals(type)) {
							...
							return (AddOnAuthor) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
