...
/**
 * ArrayOfAddOnFileDependency.java
 * <p>
...
public class ArrayOfAddOnFileDependency implements ADBBean {
	private static final QName addOnFileDependencyQName = new QName("Curse.AddOns", "AddOnFileDependency");
	...
	/**
	 * field for AddOnFileDependency
	 * This was an Array!
	 */
	protected AddOnFileDependency[] localAddOnFileDependency;
	...
	public AddOnFileDependency[] getAddOnFileDependency() {
		return localAddOnFileDependency;
	}
	...
	public void setAddOnFileDependency(AddOnFileDependency[] param) {
		validateAddOnFileDependency(param);

		localAddOnFileDependencyTracker = true;

		this.localAddOnFileDependency = param;
	}
	...
	public void addAddOnFileDependency(AddOnFileDependency param) {
		if (localAddOnFileDependency == null) {
			localAddOnFileDependency = new AddOnFileDependency[]{};
		}

		//update the setting tracker
		localAddOnFileDependencyTracker = true;

		List list = ConverterUtil.toList(localAddOnFileDependency);
		list.add(param);
		this.localAddOnFileDependency = (AddOnFileDependency[]) list.toArray(new AddOnFileDependency[list.size()]);
	}
		...
		if (list != null) {
			for (AddOnFileDependency aLocalAddOnFileDependency : list) {
				if (aLocalAddOnFileDependency != null) {
					aLocalAddOnFileDependency.serialize(addOnFileDependencyQName, xmlWriter);
				} else {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ArrayOfAddOnFileDependency", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfAddOnFileDependency", xmlWriter);
			}
		}
	...
	public static class Factory {
		...
		public static List<AddOnFileDependency> parse(XMLStreamReader reader) throws Exception {
			...
			try {
				...
				if (reader.isStartElement() && addOnFileDependencyQName.equals(reader.getName())) {
					...
					while (!loopDone1) {
						...
						if (reader.isEndElement()) {
							...
							if (addOnFileDependencyQName.equals(reader.getName())) {
								nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
