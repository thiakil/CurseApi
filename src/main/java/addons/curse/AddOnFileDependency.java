...
/**
 * AddOnFileDependency bean class
 */
...
public class AddOnFileDependency implements ADBBean {
	 ...
	 * field for Type
	 */
	protected DependencyType localType;
	 ...
	 * @param param Type
	 */
	public void setType(DependencyType param) {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":AddOnFileDependency", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "AddOnFileDependency", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static AddOnFileDependency parse(XMLStreamReader reader) throws Exception {
			AddOnFileDependency object = new AddOnFileDependency();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"AddOnFileDependency".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (AddOnFileDependency) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
