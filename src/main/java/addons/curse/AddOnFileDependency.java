...
public class AddOnFileDependency implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":AddOnFileDependency", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
		...
		if (localTypeTracker) {
			...
			localType.serialize(new QName("Curse.AddOns",
					"Type"), xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 */
		public static AddOnFileDependency parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"AddOnFileDependency".equals(type)) {
							...
							return (AddOnFileDependency) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName("Curse.AddOns", "AddOnId").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						throw new ADBException(
								"The element: " + "AddOnId" + "  cannot be null");
					}

					String content = reader.getElementText();

					object.setAddOnId(ConverterUtil.convertToInt(
							content));
				...
				if (reader.isStartElement() &&
						new QName("Curse.AddOns", "Type").equals(
								reader.getName())) {
					object.setType(DependencyType.Factory.parse(
							reader));
