...
/**
 * CategorySectionE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class CategorySectionE implements ADBBean {
	public static final QName MY_QNAME = new QName("Curse.AddOns", "CategorySection", "ns4");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localCategorySection == null) {
			...
			writeStartElement(null, namespace, "CategorySection", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localCategorySection.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static CategorySectionE parse(XMLStreamReader reader) throws Exception {
			CategorySectionE object = new CategorySectionE();
