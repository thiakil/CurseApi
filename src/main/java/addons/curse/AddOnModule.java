...
public class AddOnModule implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":AddOnModule", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"AddOnModule", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static AddOnModule parse(XMLStreamReader reader)
				throws Exception {
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"AddOnModule".equals(type)) {
							...
							return (AddOnModule) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName("Curse.AddOns",
								"Fingerprint").equals(reader.getName())) {
					...
					object.setFingerprint(ConverterUtil.convertToLong(
							content));
				...
				if (reader.isStartElement() &&
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setFoldername(ConverterUtil.convertToString(
								content));
					} else {
