...
/**
 * FuzzyMatchE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class FuzzyMatchE implements ADBBean {
	public static final QName MY_QNAME = new QName("Curse.AddOns", "FuzzyMatch", "ns4");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localFuzzyMatch == null) {
			...
			writeStartElement(null, namespace, "FuzzyMatch", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localFuzzyMatch.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static FuzzyMatchE parse(XMLStreamReader reader) throws Exception {
			FuzzyMatchE object = new FuzzyMatchE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("Curse.AddOns", "FuzzyMatch").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setFuzzyMatch(null);
								reader.next();
							} else {
								object.setFuzzyMatch(FuzzyMatch.Factory.parse(reader));
							}
