...
public class ArrayOfAddOnModule implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ArrayOfAddOnModule", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ArrayOfAddOnModule", xmlWriter);
			}
		}

		if (localAddOnModuleTracker) {
			if (localAddOnModule != null) {
				for (int i = 0; i < localAddOnModule.length; i++) {
					if (localAddOnModule[i] != null) {
						localAddOnModule[i].serialize(new QName(
								"Curse.AddOns", "AddOnModule"), xmlWriter);
					} else {
						writeStartElement(null, "Curse.AddOns", "AddOnModule",
								xmlWriter);
				...
				writeStartElement(null, "Curse.AddOns", "AddOnModule", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfAddOnModule parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfAddOnModule".equals(type)) {
							...
							return (ArrayOfAddOnModule) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName("Curse.AddOns",
								"AddOnModule").equals(reader.getName())) {
						...
						if (reader.isEndElement()) {
							...
							if (new QName("Curse.AddOns",
								...
								if ("true".equals(nillableValue) ||
									...
									list1.add(AddOnModule.Factory.parse(
											reader));
								}
							} else {
								loopDone1 = true;
					...
					object.setAddOnModule((AddOnModule[]) ConverterUtil.convertToArray(
							AddOnModule.class, list1));
