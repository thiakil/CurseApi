...
public class DownloadToken implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":DownloadToken", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"DownloadToken", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static DownloadToken parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"DownloadToken".equals(type)) {
							...
							return (DownloadToken) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setIPAddress(ConverterUtil.convertToString(
								content));
					} else {
				...
				if (reader.isStartElement() &&
					...
					object.setTimestamp(ConverterUtil.convertToDateTime(
							content));
