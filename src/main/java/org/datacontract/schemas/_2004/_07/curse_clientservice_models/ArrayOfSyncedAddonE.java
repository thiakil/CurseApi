...
/**
 *  ArrayOfSyncedAddonE bean class
 */
@SuppressWarnings({"unchecked",
		"unused"
})
public class ArrayOfSyncedAddonE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models",
			"ArrayOfSyncedAddon", "ns5");

	/**
	 * field for ArrayOfSyncedAddon
	 */
	protected ArrayOfSyncedAddon localArrayOfSyncedAddon;

	/**
	 * Auto generated getter method
	 * @return org.datacontract.schemas._2004._07.curse_clientservice_models.ArrayOfSyncedAddon
	 */
	public ArrayOfSyncedAddon getArrayOfSyncedAddon() {
		return localArrayOfSyncedAddon;
	}

	/**
	 * Auto generated setter method
	 * @param param ArrayOfSyncedAddon
	 */
	public void setArrayOfSyncedAddon(
			ArrayOfSyncedAddon param) {
		this.localArrayOfSyncedAddon = param;
	}
	...
	public void serialize(final QName parentQName,
		...
		if (localArrayOfSyncedAddon == null) {
			String namespace = "http://schemas.datacontract.org/2004/07/Curse.ClientService.Models";
			writeStartElement(null, namespace, "ArrayOfSyncedAddon", xmlWriter);
			...
			localArrayOfSyncedAddon.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfSyncedAddonE parse(
				XMLStreamReader reader) throws Exception {
			ArrayOfSyncedAddonE object = new ArrayOfSyncedAddonE();
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
							...
							if ("true".equals(nillableValue) ||
								...
								object.setArrayOfSyncedAddon(null);
								reader.next();
							} else {
								object.setArrayOfSyncedAddon(ArrayOfSyncedAddon.Factory.parse(
										reader));
							}
