...
/**
 *  FileTypeE bean class
 */
@SuppressWarnings({"unchecked",
		"unused"
})
public class FileTypeE implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (localFileType == null) {
			...
			localFileType.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static FileTypeE parse(XMLStreamReader reader)
				throws Exception {
			FileTypeE object = new FileTypeE();
