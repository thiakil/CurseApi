...
public class RepositoryMatchE implements ADBBean {
	 ...
	 */
	public void setRepositoryMatch(
	...
	public static class Factory {
		 ...
		 */
		public static RepositoryMatchE parse(
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
								new QName(
										"http://schemas.datacontract.org/2004/07/Curse.AddOns",
										"RepositoryMatch").equals(reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
									"nil");
							...
							if ("true".equals(nillableValue) ||
								...
								object.setRepositoryMatch(RepositoryMatch.Factory.parse(
										reader));
							}
