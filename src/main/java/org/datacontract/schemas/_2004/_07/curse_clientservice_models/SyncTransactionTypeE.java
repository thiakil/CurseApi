...
public class SyncTransactionTypeE implements ADBBean {
	 ...
	 */
	public void setSyncTransactionType(
			SyncTransactionType param) {
	...
	public static class Factory {
		 ...
		 */
		public static SyncTransactionTypeE parse(
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
							...
							if ("true".equals(nillableValue) ||
								...
								object.setSyncTransactionType(SyncTransactionType.Factory.parse(
										reader));
							}
