...
public class ArrayOfAddOnFileKey implements ADBBean {
	 ...
	 */
	protected void validateAddOnFileKey(
			AddOnFileKey[] param) {
	}
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ArrayOfAddOnFileKey", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ArrayOfAddOnFileKey", xmlWriter);
			}
		}

		if (localAddOnFileKeyTracker) {
			if (localAddOnFileKey != null) {
				for (int i = 0; i < localAddOnFileKey.length; i++) {
					if (localAddOnFileKey[i] != null) {
						localAddOnFileKey[i].serialize(new QName(
								"http://schemas.datacontract.org/2004/07/Curse.AddOnService.Requests",
								"AddOnFileKey"), xmlWriter);
					} else {
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfAddOnFileKey parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfAddOnFileKey".equals(type)) {
							...
							return (ArrayOfAddOnFileKey) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
					...
					if ("true".equals(nillableValue) ||
						...
						list1.add(AddOnFileKey.Factory.parse(
								reader));
					}
					...
					object.setAddOnFileKey((AddOnFileKey[]) ConverterUtil.convertToArray(
							AddOnFileKey.class,
							list1));
