...
public class ArrayOfSyncedComputer implements ADBBean {
	 ...
	 */
	protected void validateSyncedComputer(
			SyncedComputer[] param) {
	}
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ArrayOfSyncedComputer", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ArrayOfSyncedComputer", xmlWriter);
			}
		}

		if (localSyncedComputerTracker) {
			if (localSyncedComputer != null) {
				for (int i = 0; i < localSyncedComputer.length; i++) {
					if (localSyncedComputer[i] != null) {
						localSyncedComputer[i].serialize(new QName(
								"http://schemas.datacontract.org/2004/07/Curse.ClientService.Models",
								"SyncedComputer"), xmlWriter);
					} else {
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfSyncedComputer parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfSyncedComputer".equals(type)) {
							...
							return (ArrayOfSyncedComputer) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://schemas.datacontract.org/2004/07/Curse.ClientService.Models",
								"SyncedComputer").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						list1.add(SyncedComputer.Factory.parse(
								reader));
					}
					...
					object.setSyncedComputer((SyncedComputer[]) ConverterUtil.convertToArray(
							SyncedComputer.class,
							list1));
