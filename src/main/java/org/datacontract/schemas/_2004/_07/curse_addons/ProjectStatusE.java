...
/**
 * ProjectStatusE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class ProjectStatusE implements ADBBean {
	 ...
	 */
	protected ProjectStatus localProjectStatus;
	 ...
	 */
	public void setProjectStatus(ProjectStatus param) {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localProjectStatus == null) {
			...
			localProjectStatus.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static ProjectStatusE parse(XMLStreamReader reader) throws Exception {
			ProjectStatusE object = new ProjectStatusE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.AddOns", "ProjectStatus").equals(reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setProjectStatus(null);
								reader.next();
							} else {
								object.setProjectStatus(ProjectStatus.Factory.parse(reader));
							}
