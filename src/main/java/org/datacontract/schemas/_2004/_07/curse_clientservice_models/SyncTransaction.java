...
public class SyncTransaction implements ADBBean {
	 ...
	 * @param param Type
	 */
	public void setType(SyncTransactionType param) {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SyncTransaction", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SyncTransaction", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static SyncTransaction parse(XMLStreamReader reader) throws Exception {
			SyncTransaction object = new SyncTransaction();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"SyncTransaction".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (SyncTransaction) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
