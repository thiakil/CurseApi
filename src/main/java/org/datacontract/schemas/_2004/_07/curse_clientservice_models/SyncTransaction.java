...
public class SyncTransaction implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SyncTransaction", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
	...
	public static class Factory {
		 ...
		 */
		public static SyncTransaction parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SyncTransaction".equals(type)) {
							...
							return (SyncTransaction) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
					...
					object.setType(SyncTransactionType.Factory.parse(
							reader));
