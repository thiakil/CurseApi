...
/**
 * SyncedAddonE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class SyncedAddonE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedAddon", "ns5");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localSyncedAddon == null) {
			...
			writeStartElement(null, namespace, "SyncedAddon", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localSyncedAddon.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static SyncedAddonE parse(XMLStreamReader reader) throws Exception {
			SyncedAddonE object = new SyncedAddonE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedAddon").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setSyncedAddon(null);
								reader.next();
							} else {
								object.setSyncedAddon(SyncedAddon.Factory.parse(reader));
							}
