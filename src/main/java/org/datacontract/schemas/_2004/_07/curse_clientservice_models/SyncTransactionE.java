...
/**
 * SyncTransactionE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class SyncTransactionE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncTransaction", "ns5");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localSyncTransaction == null) {
			...
			writeStartElement(null, namespace, "SyncTransaction", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localSyncTransaction.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static SyncTransactionE parse(XMLStreamReader reader) throws Exception {
			SyncTransactionE object = new SyncTransactionE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncTransaction").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setSyncTransaction(null);
								reader.next();
							} else {
								object.setSyncTransaction(SyncTransaction.Factory.parse(reader));
							}
