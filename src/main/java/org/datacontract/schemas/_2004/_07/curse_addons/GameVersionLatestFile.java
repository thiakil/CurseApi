...
public class GameVersionLatestFile implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GameVersionLatestFile", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
		...
		if (localFileTypeTracker) {
			...
			localFileType.serialize(new QName(
					"http://schemas.datacontract.org/2004/07/Curse.AddOns",
					"FileType"), xmlWriter);
		}
		...
		if (localGameVesionTracker) {
			...
			writeStartElement(null, namespace, "GameVesion", xmlWriter);
		...
		if (localProjectFileIDTracker) {
			namespace = "http://schemas.datacontract.org/2004/07/Curse.AddOns";
			writeStartElement(null, namespace, "ProjectFileID", xmlWriter);

			if (localProjectFileID == Integer.MIN_VALUE) {
				throw new ADBException(
						"ProjectFileID cannot be null!!");
			} else {
		...
		if (localProjectFileNameTracker) {
			namespace = "http://schemas.datacontract.org/2004/07/Curse.AddOns";
			writeStartElement(null, namespace, "ProjectFileName", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static GameVersionLatestFile parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GameVersionLatestFile".equals(type)) {
							...
							return (GameVersionLatestFile) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://schemas.datacontract.org/2004/07/Curse.AddOns",
								"FileType").equals(reader.getName())) {
					object.setFileType(FileType.Factory.parse(
							reader));
				...
				if (reader.isStartElement() &&
						new QName(
								"http://schemas.datacontract.org/2004/07/Curse.AddOns",
								"GameVesion").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setGameVesion(ConverterUtil.convertToString(
								content));
					} else {
				...
				if (reader.isStartElement() &&
						new QName(
								"http://schemas.datacontract.org/2004/07/Curse.AddOns",
								"ProjectFileID").equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
							"nil");
					...
					if ("true".equals(nillableValue) ||
							"1".equals(nillableValue)) {
						throw new ADBException(
								"The element: " + "ProjectFileID" +
										"  cannot be null");
					}

					String content = reader.getElementText();

					object.setProjectFileID(ConverterUtil.convertToInt(
							content));
				...
				if (reader.isStartElement() &&
						new QName(
								"http://schemas.datacontract.org/2004/07/Curse.AddOns",
								"ProjectFileName").equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
							"nil");
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setProjectFileName(ConverterUtil.convertToString(
								content));
					} else {
						reader.getElementText(); // throw away text nodes if any.
					}
