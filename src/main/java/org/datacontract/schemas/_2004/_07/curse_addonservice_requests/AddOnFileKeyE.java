...
/**
 *  AddOnFileKeyE bean class
 */
@SuppressWarnings({"unchecked",
		"unused"
})
public class AddOnFileKeyE implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (localAddOnFileKey == null) {
			...
			writeStartElement(null, namespace, "AddOnFileKey", xmlWriter);
			...
			localAddOnFileKey.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static AddOnFileKeyE parse(
				XMLStreamReader reader) throws Exception {
			AddOnFileKeyE object = new AddOnFileKeyE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
								new QName(
										"http://schemas.datacontract.org/2004/07/Curse.AddOnService.Requests",
										"AddOnFileKey").equals(reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
									"nil");

							if ("true".equals(nillableValue) ||
									"1".equals(nillableValue)) {
								object.setAddOnFileKey(null);
								reader.next();
							} else {
								object.setAddOnFileKey(AddOnFileKey.Factory.parse(
										reader));
							}
