...
public class AddOnFileKeyE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.datacontract.org/2004/07/Curse.AddOnService.Requests", "AddOnFileKey", "ns6");
	...
	public static class Factory {
		 ...
		 */
		public static AddOnFileKeyE parse(XMLStreamReader reader) throws Exception {
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.AddOnService.Requests", "AddOnFileKey").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								...
								object.setAddOnFileKey(AddOnFileKey.Factory.parse(reader));
							}
