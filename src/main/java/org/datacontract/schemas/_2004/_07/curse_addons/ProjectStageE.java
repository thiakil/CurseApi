...
/**
 * ProjectStageE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class ProjectStageE implements ADBBean {
	 ...
	 */
	protected ProjectStage localProjectStage;
	 ...
	 */
	public void setProjectStage(ProjectStage param) {
		this.localProjectStage = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localProjectStage == null) {
			...
			writeStartElement(null, namespace, "ProjectStage", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localProjectStage.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static ProjectStageE parse(XMLStreamReader reader) throws Exception {
			ProjectStageE object = new ProjectStageE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.AddOns", "ProjectStage").equals(reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setProjectStage(null);
								reader.next();
							} else {
								object.setProjectStage(ProjectStage.Factory.parse(reader));
							}
