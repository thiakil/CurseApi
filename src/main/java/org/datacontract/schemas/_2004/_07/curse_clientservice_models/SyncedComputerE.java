...
/**
 * SyncedComputerE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class SyncedComputerE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedComputer", "ns5");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localSyncedComputer == null) {
			...
			writeStartElement(null, namespace, "SyncedComputer", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localSyncedComputer.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static SyncedComputerE parse(XMLStreamReader reader) throws Exception {
			SyncedComputerE object = new SyncedComputerE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedComputer").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setSyncedComputer(null);
								reader.next();
							} else {
								object.setSyncedComputer(SyncedComputer.Factory.parse(reader));
							}
