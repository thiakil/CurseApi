...
public class FolderFingerprint implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":FolderFingerprint", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
	...
	public static class Factory {
		 ...
		 */
		public static FolderFingerprint parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"FolderFingerprint".equals(type)) {
							...
							return (FolderFingerprint) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://schemas.datacontract.org/2004/07/Curse.AddOns",
								"Fingerprints").equals(reader.getName())) {
