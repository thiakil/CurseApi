...
/**
 * FileStatusE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class FileStatusE implements ADBBean {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localFileStatus == null) {
			...
			writeStartElement(null, namespace, "FileStatus", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localFileStatus.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static FileStatusE parse(XMLStreamReader reader) throws Exception {
			FileStatusE object = new FileStatusE();
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.AddOns", "FileStatus").equals(reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setFileStatus(null);
								reader.next();
							} else {
