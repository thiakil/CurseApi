...
public class ArrayOfFolderFingerprintE implements ADBBean {
	 ...
	 */
	public void setArrayOfFolderFingerprint(
	...
	public void serialize(final QName parentQName,
		...
		if (localArrayOfFolderFingerprint == null) {
			...
			writeStartElement(null, namespace, "ArrayOfFolderFingerprint",
					xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfFolderFingerprintE parse(
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
								new QName(
										"http://schemas.datacontract.org/2004/07/Curse.AddOns",
										"ArrayOfFolderFingerprint").equals(
										reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
									"nil");
							...
							if ("true".equals(nillableValue) ||
								...
								object.setArrayOfFolderFingerprint(ArrayOfFolderFingerprint.Factory.parse(
										reader));
							}
