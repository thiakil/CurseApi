...
/**
 * DirectoryInfoE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class DirectoryInfoE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.datacontract.org/2004/07/System.IO", "DirectoryInfo", "ns7");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localDirectoryInfo == null) {
			...
			writeStartElement(null, namespace, "DirectoryInfo", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localDirectoryInfo.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static DirectoryInfoE parse(XMLStreamReader reader) throws Exception {
			DirectoryInfoE object = new DirectoryInfoE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/System.IO", "DirectoryInfo").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setDirectoryInfo(null);
								reader.next();
							} else {
								object.setDirectoryInfo(DirectoryInfo.Factory.parse(reader));
							}
