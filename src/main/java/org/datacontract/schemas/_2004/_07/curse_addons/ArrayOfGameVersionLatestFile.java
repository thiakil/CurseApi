...
public class ArrayOfGameVersionLatestFile implements ADBBean {
	 ...
	 */
	protected void validateGameVersionLatestFile(GameVersionLatestFile[] param) {
	}
	 ...
	 */
	public void setGameVersionLatestFile(GameVersionLatestFile[] param) {
	 ...
	 */
	public void addGameVersionLatestFile(GameVersionLatestFile param) {
			...
			try {
				...
				if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.AddOns", "GameVersionLatestFile").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						list1.add(GameVersionLatestFile.Factory.parse(reader));
					}
