...
public class ArrayOfSyncedAddon implements ADBBean {
	 ...
	 */
	protected void validateSyncedAddon(SyncedAddon[] param) {
	}
	 ...
	 */
	public void setSyncedAddon(SyncedAddon[] param) {
	 ...
	 */
	public void addSyncedAddon(SyncedAddon param) {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ArrayOfSyncedAddon", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfSyncedAddon", xmlWriter);
			}
		}
			...
			if (localSyncedAddon != null) {
				for (SyncedAddon aLocalSyncedAddon : localSyncedAddon) {
					if (aLocalSyncedAddon != null) {
						...
						writeStartElement(null, "http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedAddon", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfSyncedAddon parse(XMLStreamReader reader) throws Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfSyncedAddon".equals(type)) {
							...
							return (ArrayOfSyncedAddon) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedAddon").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						list1.add(SyncedAddon.Factory.parse(reader));
					}
					...
					object.setSyncedAddon((SyncedAddon[]) ConverterUtil.convertToArray(SyncedAddon.class, list1));
