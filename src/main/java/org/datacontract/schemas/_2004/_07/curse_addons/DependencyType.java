...
public class DependencyType implements ADBBean {
	...
	public static final String _Required = ConverterUtil.convertToString(
			"Required");
	public static final String _Optional = ConverterUtil.convertToString(
			"Optional");
	public static final String _Embedded = ConverterUtil.convertToString(
			"Embedded");
	public static final DependencyType Required = new DependencyType(_Required,
			true);
	public static final DependencyType Optional = new DependencyType(_Optional,
			true);
	public static final DependencyType Embedded = new DependencyType(_Embedded,
			true);
	...
	public String toString() {
		return localDependencyType.toString();
	}
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":DependencyType", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"DependencyType", xmlWriter);
			}
		}
	...
	public static class Factory {
		...
		public static DependencyType fromString(
		 ...
		 */
		public static DependencyType parse(
