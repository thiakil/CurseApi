...
public class ArrayOfDirectoryInfo implements ADBBean {
	 ...
	 */
	protected void validateDirectoryInfo(
			DirectoryInfo[] param) {
	}
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ArrayOfDirectoryInfo", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ArrayOfDirectoryInfo", xmlWriter);
			}
		}

		if (localDirectoryInfoTracker) {
			if (localDirectoryInfo != null) {
				for (int i = 0; i < localDirectoryInfo.length; i++) {
					if (localDirectoryInfo[i] != null) {
						localDirectoryInfo[i].serialize(new QName(
								"http://schemas.datacontract.org/2004/07/System.IO",
								"DirectoryInfo"), xmlWriter);
					} else {
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfDirectoryInfo parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfDirectoryInfo".equals(type)) {
							...
							return (ArrayOfDirectoryInfo) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
					...
					if ("true".equals(nillableValue) ||
						...
						list1.add(DirectoryInfo.Factory.parse(
								reader));
					}
					...
					object.setDirectoryInfo((DirectoryInfo[]) ConverterUtil.convertToArray(
							DirectoryInfo.class,
							list1));
