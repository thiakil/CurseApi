...
public class ProjectStatus implements ADBBean {
	...
	public String toString() {
		return localProjectStatus.toString();
	}
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ProjectStatus", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ProjectStatus", xmlWriter);
			}
		}
	...
	public static class Factory {
		...
		public static ProjectStatus fromString(
		 ...
		 */
		public static ProjectStatus parse(
