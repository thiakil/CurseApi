...
public class RepositoryMatch implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":RepositoryMatch", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"RepositoryMatch", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static RepositoryMatch parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"RepositoryMatch".equals(type)) {
							...
							return (RepositoryMatch) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
