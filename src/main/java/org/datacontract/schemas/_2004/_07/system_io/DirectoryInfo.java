...
public class DirectoryInfo extends FileSystemInfo
	...
	public void serialize(final QName parentQName,
		...
		if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", namespacePrefix + ":DirectoryInfo", xmlWriter);
		} else {
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
					"type", "DirectoryInfo", xmlWriter);
		}
	...
	public static class Factory {
		 ...
		 */
		public static DirectoryInfo parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"DirectoryInfo".equals(type)) {
							...
							return (DirectoryInfo) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
