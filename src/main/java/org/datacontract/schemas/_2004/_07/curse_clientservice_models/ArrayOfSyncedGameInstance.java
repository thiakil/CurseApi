	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ArrayOfSyncedGameInstance", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ArrayOfSyncedGameInstance", xmlWriter);
			}
		}
			...
			if (localSyncedGameInstance != null) {
				for (SyncedGameInstance aLocalSyncedGameInstance : localSyncedGameInstance) {
					if (aLocalSyncedGameInstance != null) {
						...
						writeStartElement(null, "http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedGameInstance", xmlWriter);
