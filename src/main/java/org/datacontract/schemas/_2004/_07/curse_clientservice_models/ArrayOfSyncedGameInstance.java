...
public class ArrayOfSyncedGameInstance implements ADBBean {
	 ...
	 */
	protected void validateSyncedGameInstance(
	 ...
	 */
	public void setSyncedGameInstance(
			SyncedGameInstance[] param) {
	 ...
	 */
	public void addSyncedGameInstance(
			SyncedGameInstance param) {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ArrayOfSyncedGameInstance", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ArrayOfSyncedGameInstance", xmlWriter);
			}
		}

		if (localSyncedGameInstanceTracker) {
			if (localSyncedGameInstance != null) {
				for (int i = 0; i < localSyncedGameInstance.length; i++) {
					if (localSyncedGameInstance[i] != null) {
						localSyncedGameInstance[i].serialize(new QName(
								"http://schemas.datacontract.org/2004/07/Curse.ClientService.Models",
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfSyncedGameInstance parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfSyncedGameInstance".equals(type)) {
							...
							return (ArrayOfSyncedGameInstance) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://schemas.datacontract.org/2004/07/Curse.ClientService.Models",
								"SyncedGameInstance").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						list1.add(SyncedGameInstance.Factory.parse(
								reader));
					}
					...
					object.setSyncedGameInstance((SyncedGameInstance[]) ConverterUtil.convertToArray(
							SyncedGameInstance.class,
							list1));
