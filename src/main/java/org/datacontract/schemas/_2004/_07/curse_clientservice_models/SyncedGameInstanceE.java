...
/**
 * SyncedGameInstanceE bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class SyncedGameInstanceE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedGameInstance", "ns5");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localSyncedGameInstance == null) {
			...
			writeStartElement(null, namespace, "SyncedGameInstance", xmlWriter);

			// write the nil attribute
			writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "nil", "1", xmlWriter);
			xmlWriter.writeEndElement();
		} else {
			localSyncedGameInstance.serialize(MY_QNAME, xmlWriter);
		}
	}
	...
	public static class Factory {
		 ...
		 */
		public static SyncedGameInstanceE parse(XMLStreamReader reader) throws Exception {
			SyncedGameInstanceE object = new SyncedGameInstanceE();
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models", "SyncedGameInstance").equals(reader.getName())) {
							...
							if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
								object.setSyncedGameInstance(null);
								reader.next();
							} else {
								object.setSyncedGameInstance(SyncedGameInstance.Factory.parse(reader));
							}
