...
public class ServiceResponseStatusE implements ADBBean {
	 ...
	 */
	public void setServiceResponseStatus(
	...
	public void serialize(final QName parentQName,
		...
		if (localServiceResponseStatus == null) {
			...
			writeStartElement(null, namespace, "ServiceResponseStatus",
					xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static ServiceResponseStatusE parse(
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
							...
							if ("true".equals(nillableValue) ||
								...
								object.setServiceResponseStatus(ServiceResponseStatus.Factory.parse(
										reader));
							}
