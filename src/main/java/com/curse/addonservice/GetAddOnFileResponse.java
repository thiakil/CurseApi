...
/**
 * GetAddOnFileResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetAddOnFileResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetAddOnFileResponse", "ns9");
	private static final QName getAddOnFileResultQName = new QName("http://addonservice.curse.com/", "GetAddOnFileResult");

	/**
	 * field for GetAddOnFileResult
	 */
	protected AddOnFile localGetAddOnFileResult;
	 ...
	 */
	public AddOnFile getGetAddOnFileResult() {
		return localGetAddOnFileResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param GetAddOnFileResult
	 */
	public void setGetAddOnFileResult(AddOnFile param) {
		localGetAddOnFileResultTracker = true;

		this.localGetAddOnFileResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAddOnFileResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAddOnFileResponse", xmlWriter);
			}
		}

		if (localGetAddOnFileResultTracker) {
			if (localGetAddOnFileResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "GetAddOnFileResult", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localGetAddOnFileResult.serialize(getAddOnFileResultQName, xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnFileResponse parse(XMLStreamReader reader) throws Exception {
			GetAddOnFileResponse object = new GetAddOnFileResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnFileResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAddOnFileResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && getAddOnFileResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setGetAddOnFileResult(null);
						reader.next();

						reader.next();
					} else {
						object.setGetAddOnFileResult(AddOnFile.Factory.parse(reader));
