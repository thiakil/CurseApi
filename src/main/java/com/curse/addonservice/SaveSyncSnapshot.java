...
public class SaveSyncSnapshot implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SaveSyncSnapshot", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SaveSyncSnapshot", xmlWriter);
			}
		}
		...
		if (localSyncedAddonsTracker) {
			if (localSyncedAddons == null) {
				...
				localSyncedAddons.serialize(new QName(
								"http://addonservice.curse.com/", "syncedAddons"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static SaveSyncSnapshot parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SaveSyncSnapshot".equals(type)) {
							...
							return (SaveSyncSnapshot) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "syncedAddons").equals(
								reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
							"nil");
					...
					if ("true".equals(nillableValue) ||
						...
						object.setSyncedAddons(ArrayOfSyncedAddon.Factory.parse(
								reader));
