	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":SaveSyncSnapshot", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "SaveSyncSnapshot", xmlWriter);
			}
		}
		...
		if (localSyncedAddonsTracker) {
			if (localSyncedAddons == null) {
				writeStartElement(null, "http://addonservice.curse.com/", "syncedAddons", xmlWriter);
