...
/**
 * JoinSyncGroupResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class JoinSyncGroupResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "JoinSyncGroupResponse", "ns9");
	private static final QName joinSyncGroupResultQName = new QName("http://addonservice.curse.com/", "JoinSyncGroupResult");

	/**
	 * field for JoinSyncGroupResult
	 */
	protected ServiceResponse localJoinSyncGroupResult;
	 ...
	 */
	public ServiceResponse getJoinSyncGroupResult() {
		return localJoinSyncGroupResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param JoinSyncGroupResult
	 */
	public void setJoinSyncGroupResult(ServiceResponse param) {
		localJoinSyncGroupResultTracker = true;

		this.localJoinSyncGroupResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":JoinSyncGroupResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "JoinSyncGroupResponse", xmlWriter);
			}
		}

		if (localJoinSyncGroupResultTracker) {
			if (localJoinSyncGroupResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "JoinSyncGroupResult", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localJoinSyncGroupResult.serialize(joinSyncGroupResultQName, xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static JoinSyncGroupResponse parse(XMLStreamReader reader) throws Exception {
			JoinSyncGroupResponse object = new JoinSyncGroupResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"JoinSyncGroupResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (JoinSyncGroupResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && joinSyncGroupResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setJoinSyncGroupResult(null);
						reader.next();

						reader.next();
					} else {
						object.setJoinSyncGroupResult(ServiceResponse.Factory.parse(reader));
