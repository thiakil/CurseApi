...
public class ServiceHealthCheckResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/",
			"ServiceHealthCheckResponse", "ns9");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ServiceHealthCheckResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ServiceHealthCheckResponse", xmlWriter);
			}
		}

		if (localServiceHealthCheckResultTracker) {
			namespace = "http://addonservice.curse.com/";
			writeStartElement(null, namespace, "ServiceHealthCheckResult",
					xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static ServiceHealthCheckResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ServiceHealthCheckResponse".equals(type)) {
							...
							return (ServiceHealthCheckResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"ServiceHealthCheckResult").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setServiceHealthCheckResult(ConverterUtil.convertToString(
								content));
					} else {
