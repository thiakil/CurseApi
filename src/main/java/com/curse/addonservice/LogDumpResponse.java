...
public class LogDumpResponse implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":LogDumpResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"LogDumpResponse", xmlWriter);
			}
		}
		...
		if (localLogDumpResultTracker) {
			if (localLogDumpResult == null) {
				...
				localLogDumpResult.serialize(new QName(
								"http://addonservice.curse.com/", "LogDumpResult"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static LogDumpResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"LogDumpResponse".equals(type)) {
							...
							return (LogDumpResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "LogDumpResult").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setLogDumpResult(ArrayOfstring.Factory.parse(
								reader));
