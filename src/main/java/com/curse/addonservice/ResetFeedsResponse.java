...
public class ResetFeedsResponse implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ResetFeedsResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ResetFeedsResponse", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static ResetFeedsResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ResetFeedsResponse".equals(type)) {
							...
							return (ResetFeedsResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "ResetFeedsResult").equals(
								reader.getName())) {
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setResetFeedsResult(ConverterUtil.convertToString(
								content));
					} else {
