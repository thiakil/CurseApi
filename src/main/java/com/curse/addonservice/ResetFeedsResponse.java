...
public class ResetFeedsResponse implements ADBBean {
	 ...
	 */
	protected String localResetFeedsResult;
	 ...
	 */
	public String getResetFeedsResult() {
		return localResetFeedsResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param ResetFeedsResult
	 */
	public void setResetFeedsResult(String param) {
		localResetFeedsResultTracker = true;

		this.localResetFeedsResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ResetFeedsResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ResetFeedsResponse", xmlWriter);
			}
		}

		if (localResetFeedsResultTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "ResetFeedsResult", xmlWriter);

			if (localResetFeedsResult == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localResetFeedsResult);
			}
	...
	public static class Factory {
		 ...
		 */
		public static ResetFeedsResponse parse(XMLStreamReader reader) throws Exception {
			ResetFeedsResponse object = new ResetFeedsResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ResetFeedsResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (ResetFeedsResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && new QName("http://addonservice.curse.com/", "ResetFeedsResult").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setResetFeedsResult(ConverterUtil.convertToString(content));
					} else {
