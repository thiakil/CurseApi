...
public class GetDownloadToken implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetDownloadToken", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetDownloadToken", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetDownloadToken parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetDownloadToken".equals(type)) {
							...
							return (GetDownloadToken) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
