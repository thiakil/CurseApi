...
/**
 * GetDownloadToken bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetDownloadToken implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetDownloadToken", "ns9");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetDownloadToken", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetDownloadToken", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetDownloadToken parse(XMLStreamReader reader) throws Exception {
			GetDownloadToken object = new GetDownloadToken();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetDownloadToken".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetDownloadToken) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
