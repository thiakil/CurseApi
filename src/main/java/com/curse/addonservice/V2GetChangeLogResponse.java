...
/**
 * V2GetChangeLogResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class V2GetChangeLogResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "v2GetChangeLogResponse", "ns9");
	private static final QName v2GetChangeLogResultQName = new QName("http://addonservice.curse.com/", "v2GetChangeLogResult");

	/**
	 * field for V2GetChangeLogResult
	 */
	protected String localV2GetChangeLogResult;
	 ...
	 */
	public String getV2GetChangeLogResult() {
		return localV2GetChangeLogResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param V2GetChangeLogResult
	 */
	public void setV2GetChangeLogResult(String param) {
		localV2GetChangeLogResultTracker = true;

		this.localV2GetChangeLogResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":v2GetChangeLogResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "v2GetChangeLogResponse", xmlWriter);
			}
		}

		if (localV2GetChangeLogResultTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "v2GetChangeLogResult", xmlWriter);

			if (localV2GetChangeLogResult == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localV2GetChangeLogResult);
			}
	...
	public static class Factory {
		 ...
		 */
		public static V2GetChangeLogResponse parse(XMLStreamReader reader) throws Exception {
			V2GetChangeLogResponse object = new V2GetChangeLogResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"v2GetChangeLogResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (V2GetChangeLogResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && v2GetChangeLogResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						String content = reader.getElementText();

						object.setV2GetChangeLogResult(ConverterUtil.convertToString(content));
					} else {
