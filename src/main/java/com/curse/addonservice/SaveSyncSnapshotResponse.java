...
public class SaveSyncSnapshotResponse implements ADBBean {
	 ...
	 */
	public void setSaveSyncSnapshotResult(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SaveSyncSnapshotResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SaveSyncSnapshotResponse", xmlWriter);
			}
		}
		...
		if (localSaveSyncSnapshotResultTracker) {
			if (localSaveSyncSnapshotResult == null) {
				writeStartElement(null, "http://addonservice.curse.com/",
						"SaveSyncSnapshotResult", xmlWriter);
				...
				localSaveSyncSnapshotResult.serialize(new QName(
						"http://addonservice.curse.com/",
						"SaveSyncSnapshotResult"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static SaveSyncSnapshotResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SaveSyncSnapshotResponse".equals(type)) {
							...
							return (SaveSyncSnapshotResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"SaveSyncSnapshotResult").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setSaveSyncSnapshotResult(ServiceResponse.Factory.parse(
								reader));
