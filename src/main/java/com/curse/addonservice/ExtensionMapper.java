...
public class ExtensionMapper {
	public static Object getTypeObject(
		...
		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) && "PackageTypes".equals(typeName)) {
			return PackageTypes.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) && "ProjectStage".equals(typeName)) {
		...
		if ("Curse.AddOns".equals(namespaceURI) &&
				"AddOnFileDependency".equals(typeName)) {
			return AddOnFileDependency.Factory.parse(reader);
		}

		if ("Curse.AddOns".equals(namespaceURI) &&
				"FingerprintMatch".equals(typeName)) {
			return FingerprintMatch.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "ArrayOfSyncedComputer".equals(typeName)) {
			return ArrayOfSyncedComputer.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) && "FileStatus".equals(typeName)) {
		...
		if ("http://schemas.microsoft.com/2003/10/Serialization/Arrays".equals(
				namespaceURI) &&
				"ArrayOfKeyValueOfintArrayOfAddOnFileHlmYZPzp".equals(typeName)) {
			return ArrayOfKeyValueOfintArrayOfAddOnFileHlmYZPzp.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/System.IO".equals(
				namespaceURI) && "ArrayOfDirectoryInfo".equals(typeName)) {
			return ArrayOfDirectoryInfo.Factory.parse(reader);
		}

		if ("Curse.AddOns".equals(namespaceURI) &&
				"DownloadToken".equals(typeName)) {
			return DownloadToken.Factory.parse(reader);
		}

		if ("Curse.AddOns".equals(namespaceURI) &&
				"AddOnModule".equals(typeName)) {
			return AddOnModule.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "SyncedAddon".equals(typeName)) {
			return SyncedAddon.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "ServiceResponse".equals(typeName)) {
			return ServiceResponse.Factory.parse(reader);
		}

		if ("Curse.AddOns".equals(namespaceURI) &&
				"ArrayOfAddOnCategory".equals(typeName)) {
		...
		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) && "DependencyType".equals(typeName)) {
			return DependencyType.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) && "GameVersionLatestFile".equals(typeName)) {
			return GameVersionLatestFile.Factory.parse(reader);
		}

		if ("Curse.AddOns".equals(namespaceURI) &&
				"ArrayOfAddOnFile".equals(typeName)) {
			return ArrayOfAddOnFile.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "SyncTransaction".equals(typeName)) {
			return SyncTransaction.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "SyncedComputer".equals(typeName)) {
			return SyncedComputer.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) &&
				"ServiceResponseOfSyncedGameInstanceeheogrl4".equals(typeName)) {
			return ServiceResponseOfSyncedGameInstanceeheogrl4.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.AddOnService.Requests".equals(
				namespaceURI) && "ArrayOfAddOnFileKey".equals(typeName)) {
			return ArrayOfAddOnFileKey.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/System.IO".equals(
				namespaceURI) && "DirectoryInfo".equals(typeName)) {
			return DirectoryInfo.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) && "FolderFingerprint".equals(typeName)) {
			return FolderFingerprint.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) && "ProjectStatus".equals(typeName)) {
			return ProjectStatus.Factory.parse(reader);
		}

		if ("http://schemas.microsoft.com/2003/10/Serialization/Arrays".equals(
				namespaceURI) &&
				"KeyValueOfintArrayOfAddOnFileHlmYZPzp_type0".equals(typeName)) {
			return KeyValueOfintArrayOfAddOnFileHlmYZPzp_type0.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "ServiceResponseStatus".equals(typeName)) {
			return ServiceResponseStatus.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "ArrayOfSyncedAddon".equals(typeName)) {
		...
		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "ArrayOfSyncTransaction".equals(typeName)) {
			return ArrayOfSyncTransaction.Factory.parse(reader);
		}

		if ("Curse.AddOns".equals(namespaceURI) &&
				"FingerprintMatchResult".equals(typeName)) {
			return FingerprintMatchResult.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "SyncTransactionType".equals(typeName)) {
			return SyncTransactionType.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) && "SyncedGameInstance".equals(typeName)) {
		...
		if ("http://schemas.datacontract.org/2004/07/Curse.AddOns".equals(
				namespaceURI) &&
				"ArrayOfFolderFingerprint".equals(typeName)) {
			return ArrayOfFolderFingerprint.Factory.parse(reader);
		}

		if ("Curse.AddOns".equals(namespaceURI) &&
				"ArrayOfAddOnAttachment".equals(typeName)) {
			return ArrayOfAddOnAttachment.Factory.parse(reader);
		}

		if ("http://schemas.datacontract.org/2004/07/Curse.ClientService.Models".equals(
				namespaceURI) &&
				"ServiceResponseOfArrayOfSyncedGameInstanceeheogrl4".equals(
						typeName)) {
