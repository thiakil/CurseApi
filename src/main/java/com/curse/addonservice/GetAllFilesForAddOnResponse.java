...
public class GetAllFilesForAddOnResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/",
			"GetAllFilesForAddOnResponse", "ns9");
	 ...
	 */
	public void setGetAllFilesForAddOnResult(
			ArrayOfAddOnFile param) {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetAllFilesForAddOnResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetAllFilesForAddOnResponse", xmlWriter);
			}
		}
		...
		if (localGetAllFilesForAddOnResultTracker) {
			if (localGetAllFilesForAddOnResult == null) {
				writeStartElement(null, "http://addonservice.curse.com/",
						"GetAllFilesForAddOnResult", xmlWriter);
				...
				localGetAllFilesForAddOnResult.serialize(new QName(
						"http://addonservice.curse.com/",
						"GetAllFilesForAddOnResult"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAllFilesForAddOnResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetAllFilesForAddOnResponse".equals(type)) {
							...
							return (GetAllFilesForAddOnResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"GetAllFilesForAddOnResult").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setGetAllFilesForAddOnResult(ArrayOfAddOnFile.Factory.parse(
								reader));
