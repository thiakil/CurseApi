...
/**
 * GetAllFilesForAddOnResponse.java
 * <p>
...
/**
 * GetAllFilesForAddOnResponse bean class
 */
...
public class GetAllFilesForAddOnResponse implements ADBBean {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAllFilesForAddOnResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAllFilesForAddOnResponse", xmlWriter);
			}
		}

		if (localGetAllFilesForAddOnResultTracker) {
			if (localGetAllFilesForAddOnResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "GetAllFilesForAddOnResult", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static GetAllFilesForAddOnResponse parse(XMLStreamReader reader) throws Exception {
			GetAllFilesForAddOnResponse object = new GetAllFilesForAddOnResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAllFilesForAddOnResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAllFilesForAddOnResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && new QName("http://addonservice.curse.com/", "GetAllFilesForAddOnResult").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setGetAllFilesForAddOnResult(null);
						reader.next();

						reader.next();
					} else {
						object.setGetAllFilesForAddOnResult(ArrayOfAddOnFile.Factory.parse(reader));
