...
/**
 * GetFuzzyMatchesResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetFuzzyMatchesResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetFuzzyMatchesResponse", "ns9");
	private static final QName getFuzzyMatchesResultQName = new QName("http://addonservice.curse.com/", "GetFuzzyMatchesResult");

	/**
	 * field for GetFuzzyMatchesResult
	 */
	protected ArrayOfFuzzyMatch localGetFuzzyMatchesResult;
	 ...
	 */
	public ArrayOfFuzzyMatch getGetFuzzyMatchesResult() {
		return localGetFuzzyMatchesResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param GetFuzzyMatchesResult
	 */
	public void setGetFuzzyMatchesResult(ArrayOfFuzzyMatch param) {
		localGetFuzzyMatchesResultTracker = true;

		this.localGetFuzzyMatchesResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetFuzzyMatchesResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetFuzzyMatchesResponse", xmlWriter);
			}
		}

		if (localGetFuzzyMatchesResultTracker) {
			if (localGetFuzzyMatchesResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "GetFuzzyMatchesResult", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localGetFuzzyMatchesResult.serialize(getFuzzyMatchesResultQName, xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetFuzzyMatchesResponse parse(XMLStreamReader reader) throws Exception {
			GetFuzzyMatchesResponse object = new GetFuzzyMatchesResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetFuzzyMatchesResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetFuzzyMatchesResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && getFuzzyMatchesResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setGetFuzzyMatchesResult(null);
						reader.next();

						reader.next();
					} else {
						object.setGetFuzzyMatchesResult(ArrayOfFuzzyMatch.Factory.parse(reader));
