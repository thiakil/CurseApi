...
/**
 * HealthCheck bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class HealthCheck implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "HealthCheck", "ns9");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":HealthCheck", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "HealthCheck", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static HealthCheck parse(XMLStreamReader reader) throws Exception {
			HealthCheck object = new HealthCheck();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"HealthCheck".equals(type)) {
							...
							return (HealthCheck) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
