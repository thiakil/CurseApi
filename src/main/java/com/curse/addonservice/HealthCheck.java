...
public class HealthCheck implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":HealthCheck", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"HealthCheck", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static HealthCheck parse(XMLStreamReader reader)
				throws Exception {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"HealthCheck".equals(type)) {
							...
							return (HealthCheck) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
