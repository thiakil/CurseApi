	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":v2GetAddOnsResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "v2GetAddOnsResponse", xmlWriter);
			}
		}

		if (localV2GetAddOnsResultTracker) {
			if (localV2GetAddOnsResult == null) {
				writeStartElement(null, "http://addonservice.curse.com/", "v2GetAddOnsResult", xmlWriter);
