...
public class V2GetAddOnsResponse implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":v2GetAddOnsResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"v2GetAddOnsResponse", xmlWriter);
			}
		}
		...
		if (localV2GetAddOnsResultTracker) {
			if (localV2GetAddOnsResult == null) {
				...
				localV2GetAddOnsResult.serialize(new QName(
								"http://addonservice.curse.com/", "v2GetAddOnsResult"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static V2GetAddOnsResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"v2GetAddOnsResponse".equals(type)) {
							...
							return (V2GetAddOnsResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"v2GetAddOnsResult").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setV2GetAddOnsResult(ArrayOfAddOn.Factory.parse(
								reader));
