...
public class V2GetAddOnDescriptionResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/",
			"v2GetAddOnDescriptionResponse", "ns9");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":v2GetAddOnDescriptionResponse",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"v2GetAddOnDescriptionResponse", xmlWriter);
			}
		}

		if (localV2GetAddOnDescriptionResultTracker) {
			namespace = "http://addonservice.curse.com/";
			writeStartElement(null, namespace, "v2GetAddOnDescriptionResult",
					xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static V2GetAddOnDescriptionResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"v2GetAddOnDescriptionResponse".equals(type)) {
							...
							return (V2GetAddOnDescriptionResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"v2GetAddOnDescriptionResult").equals(
								reader.getName())) {
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setV2GetAddOnDescriptionResult(ConverterUtil.convertToString(
								content));
					} else {
