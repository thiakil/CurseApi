	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":v2GetAddOnDescriptionResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "v2GetAddOnDescriptionResponse", xmlWriter);
			}
		}

		if (localV2GetAddOnDescriptionResultTracker) {
			namespace = "http://addonservice.curse.com/";
			writeStartElement(null, namespace, "v2GetAddOnDescriptionResult", xmlWriter);
