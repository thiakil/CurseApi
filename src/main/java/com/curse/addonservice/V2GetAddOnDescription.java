...
public class V2GetAddOnDescription implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":v2GetAddOnDescription", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"v2GetAddOnDescription", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static V2GetAddOnDescription parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"v2GetAddOnDescription".equals(type)) {
							...
							return (V2GetAddOnDescription) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
