...
public class GetAddOnDescription implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetAddOnDescription", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetAddOnDescription", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnDescription parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnDescription".equals(type)) {
							...
							return (GetAddOnDescription) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
