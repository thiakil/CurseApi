...
public class ResetSingleAddonCache implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ResetSingleAddonCache", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ResetSingleAddonCache", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static ResetSingleAddonCache parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ResetSingleAddonCache".equals(type)) {
							...
							return (ResetSingleAddonCache) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
