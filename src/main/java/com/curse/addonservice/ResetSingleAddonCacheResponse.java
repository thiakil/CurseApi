...
public class ResetSingleAddonCacheResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/",
			"ResetSingleAddonCacheResponse", "ns9");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ResetSingleAddonCacheResponse",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ResetSingleAddonCacheResponse", xmlWriter);
			}
		}

		if (localResetSingleAddonCacheResultTracker) {
			namespace = "http://addonservice.curse.com/";
			writeStartElement(null, namespace, "ResetSingleAddonCacheResult",
					xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static ResetSingleAddonCacheResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ResetSingleAddonCacheResponse".equals(type)) {
							...
							return (ResetSingleAddonCacheResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"ResetSingleAddonCacheResult").equals(
								reader.getName())) {
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setResetSingleAddonCacheResult(ConverterUtil.convertToString(
								content));
					} else {
