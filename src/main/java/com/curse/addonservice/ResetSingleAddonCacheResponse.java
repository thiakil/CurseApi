...
public class ResetSingleAddonCacheResponse implements ADBBean {
	...
	private static final QName resetSingleAddonCacheResultQName = new QName("http://addonservice.curse.com/", "ResetSingleAddonCacheResult");
	...
	public static class Factory {
		...
		public static ResetSingleAddonCacheResponse parse(XMLStreamReader reader) throws Exception {
			...
			try {
				...
				if (reader.isStartElement() && resetSingleAddonCacheResultQName.equals(reader.getName())) {
