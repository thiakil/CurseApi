...
public class ListFeedsResponse implements ADBBean {
	 ...
	 */
	public void setListFeedsResult(
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ListFeedsResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ListFeedsResponse", xmlWriter);
			}
		}
		...
		if (localListFeedsResultTracker) {
			if (localListFeedsResult == null) {
				...
				localListFeedsResult.serialize(new QName(
								"http://addonservice.curse.com/", "ListFeedsResult"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static ListFeedsResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ListFeedsResponse".equals(type)) {
							...
							return (ListFeedsResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "ListFeedsResult").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setListFeedsResult(ArrayOfDirectoryInfo.Factory.parse(
								reader));
