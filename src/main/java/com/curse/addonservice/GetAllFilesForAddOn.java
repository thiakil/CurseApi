...
public class GetAllFilesForAddOn implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetAllFilesForAddOn", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetAllFilesForAddOn", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAllFilesForAddOn parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetAllFilesForAddOn".equals(type)) {
							...
							return (GetAllFilesForAddOn) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "addOnID").equals(
								reader.getName())) {
