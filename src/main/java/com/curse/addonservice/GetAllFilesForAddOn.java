...
/**
 * GetAllFilesForAddOn bean class
 */
...
public class GetAllFilesForAddOn implements ADBBean {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAllFilesForAddOn", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAllFilesForAddOn", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAllFilesForAddOn parse(XMLStreamReader reader) throws Exception {
			GetAllFilesForAddOn object = new GetAllFilesForAddOn();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAllFilesForAddOn".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAllFilesForAddOn) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
