...
/**
 * GetSyncProfileResponse bean class
 */
...
public class GetSyncProfileResponse implements ADBBean {
	 ...
	 */
	protected ServiceResponseOfArrayOfSyncedGameInstanceeheogrl4 localGetSyncProfileResult;
	 ...
	 */
	public ServiceResponseOfArrayOfSyncedGameInstanceeheogrl4 getGetSyncProfileResult() {
		return localGetSyncProfileResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param GetSyncProfileResult
	 */
	public void setGetSyncProfileResult(ServiceResponseOfArrayOfSyncedGameInstanceeheogrl4 param) {
		localGetSyncProfileResultTracker = true;

		this.localGetSyncProfileResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetSyncProfileResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetSyncProfileResponse", xmlWriter);
			}
		}

		if (localGetSyncProfileResultTracker) {
			if (localGetSyncProfileResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "GetSyncProfileResult", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static GetSyncProfileResponse parse(XMLStreamReader reader) throws Exception {
			GetSyncProfileResponse object = new GetSyncProfileResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetSyncProfileResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetSyncProfileResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && getSyncProfileResultQName.equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setGetSyncProfileResult(null);
						reader.next();

						reader.next();
					} else {
						object.setGetSyncProfileResult(ServiceResponseOfArrayOfSyncedGameInstanceeheogrl4.Factory.parse(reader));
