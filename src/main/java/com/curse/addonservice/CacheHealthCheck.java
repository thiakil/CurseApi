...
public class CacheHealthCheck implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":CacheHealthCheck", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"CacheHealthCheck", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static CacheHealthCheck parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"CacheHealthCheck".equals(type)) {
							...
							return (CacheHealthCheck) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
