...
public class V2GetFingerprintMatches implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":v2GetFingerprintMatches", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"v2GetFingerprintMatches", xmlWriter);
			}
		}
		...
		if (localFingerprintsTracker) {
			if (localFingerprints == null) {
				...
				localFingerprints.serialize(new QName(
								"http://addonservice.curse.com/", "fingerprints"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static V2GetFingerprintMatches parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"v2GetFingerprintMatches".equals(type)) {
							...
							return (V2GetFingerprintMatches) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "fingerprints").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setFingerprints(ArrayOflong.Factory.parse(
								reader));
