...
/**
 * V2GetFingerprintMatches bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class V2GetFingerprintMatches implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "v2GetFingerprintMatches", "ns9");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":v2GetFingerprintMatches", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "v2GetFingerprintMatches", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static V2GetFingerprintMatches parse(XMLStreamReader reader) throws Exception {
			V2GetFingerprintMatches object = new V2GetFingerprintMatches();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"v2GetFingerprintMatches".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (V2GetFingerprintMatches) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
