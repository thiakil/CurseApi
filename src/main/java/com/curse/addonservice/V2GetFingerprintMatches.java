	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":v2GetFingerprintMatches", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "v2GetFingerprintMatches", xmlWriter);
			}
		}

		if (localFingerprintsTracker) {
			if (localFingerprints == null) {
				writeStartElement(null, "http://addonservice.curse.com/", "fingerprints", xmlWriter);
