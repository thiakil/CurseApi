...
public class V2GetAddOns implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":v2GetAddOns", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"v2GetAddOns", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static V2GetAddOns parse(XMLStreamReader reader)
				throws Exception {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"v2GetAddOns".equals(type)) {
							...
							return (V2GetAddOns) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
