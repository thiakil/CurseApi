...
public class ServiceHealthCheck implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ServiceHealthCheck", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ServiceHealthCheck", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static ServiceHealthCheck parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ServiceHealthCheck".equals(type)) {
							...
							return (ServiceHealthCheck) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
