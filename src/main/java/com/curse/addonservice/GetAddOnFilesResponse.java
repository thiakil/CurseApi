...
public class GetAddOnFilesResponse implements ADBBean {
	 ...
	 */
	public void setGetAddOnFilesResult(
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetAddOnFilesResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetAddOnFilesResponse", xmlWriter);
			}
		}
		...
		if (localGetAddOnFilesResultTracker) {
			if (localGetAddOnFilesResult == null) {
				...
				localGetAddOnFilesResult.serialize(new QName(
								"http://addonservice.curse.com/", "GetAddOnFilesResult"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnFilesResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnFilesResponse".equals(type)) {
							...
							return (GetAddOnFilesResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"GetAddOnFilesResult").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setGetAddOnFilesResult(ArrayOfKeyValueOfintArrayOfAddOnFileHlmYZPzp.Factory.parse(
								reader));
