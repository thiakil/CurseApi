...
/**
 * GetAddOnFilesResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetAddOnFilesResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetAddOnFilesResponse", "ns9");
	private static final QName getAddOnFilesResultQName = new QName("http://addonservice.curse.com/", "GetAddOnFilesResult");
	 ...
	 */
	protected boolean localGetAddOnFilesResultTracker = false;
	...
	public boolean isGetAddOnFilesResultSpecified() {
		return localGetAddOnFilesResultTracker;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAddOnFilesResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAddOnFilesResponse", xmlWriter);
			}
		}

		if (localGetAddOnFilesResultTracker) {
			if (localGetAddOnFilesResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "GetAddOnFilesResult", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				ArrayOfKeyValue_int_AddOnFile.serialize(getAddOnFilesResultQName, xmlWriter, localGetAddOnFilesResult);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnFilesResponse parse(XMLStreamReader reader) throws Exception {
			GetAddOnFilesResponse object = new GetAddOnFilesResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnFilesResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAddOnFilesResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && getAddOnFilesResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setGetAddOnFilesResult(null);
						reader.next();
