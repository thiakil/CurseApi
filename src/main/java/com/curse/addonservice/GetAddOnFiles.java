...
public class GetAddOnFiles implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetAddOnFiles", "ns9");
	private static final QName addOnFileKeysQName = new QName("http://addonservice.curse.com/", "addOnFileKeys");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAddOnFiles", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAddOnFiles", xmlWriter);
			}
		}

		if (localAddOnFileKeysTracker) {
			if (localAddOnFileKeys == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "addOnFileKeys", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				ArrayOfAddOnFileKey.serialize(addOnFileKeysQName, xmlWriter, localAddOnFileKeys);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnFiles parse(XMLStreamReader reader) throws Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnFiles".equals(type)) {
							...
							return (GetAddOnFiles) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && addOnFileKeysQName.equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setAddOnFileKeys(ArrayOfAddOnFileKey.Factory.parse(reader));
