...
/**
 * CacheHealthCheckResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class CacheHealthCheckResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "CacheHealthCheckResponse", "ns9");
	private static final QName cacheHealthCheckResultQName = new QName("http://addonservice.curse.com/", "CacheHealthCheckResult");

	/**
	 * field for CacheHealthCheckResult
	 */
	protected String localCacheHealthCheckResult;
	 ...
	 */
	public String getCacheHealthCheckResult() {
		return localCacheHealthCheckResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param CacheHealthCheckResult
	 */
	public void setCacheHealthCheckResult(String param) {
		localCacheHealthCheckResultTracker = true;

		this.localCacheHealthCheckResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":CacheHealthCheckResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "CacheHealthCheckResponse", xmlWriter);
			}
		}

		if (localCacheHealthCheckResultTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "CacheHealthCheckResult", xmlWriter);

			if (localCacheHealthCheckResult == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localCacheHealthCheckResult);
			}
	...
	public static class Factory {
		 ...
		 */
		public static CacheHealthCheckResponse parse(XMLStreamReader reader) throws Exception {
			CacheHealthCheckResponse object = new CacheHealthCheckResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"CacheHealthCheckResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (CacheHealthCheckResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && cacheHealthCheckResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						String content = reader.getElementText();

						object.setCacheHealthCheckResult(ConverterUtil.convertToString(content));
					} else {
