...
public class ResetAllAddonCache implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ResetAllAddonCache", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ResetAllAddonCache", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static ResetAllAddonCache parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ResetAllAddonCache".equals(type)) {
							...
							return (ResetAllAddonCache) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
