...
public class GetChangeLogResponse implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetChangeLogResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetChangeLogResponse", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetChangeLogResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetChangeLogResponse".equals(type)) {
							...
							return (GetChangeLogResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"GetChangeLogResult").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setGetChangeLogResult(ConverterUtil.convertToString(
								content));
					} else {
