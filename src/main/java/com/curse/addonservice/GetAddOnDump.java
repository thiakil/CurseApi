...
/**
 * GetAddOnDump bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetAddOnDump implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetAddOnDump", "ns9");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAddOnDump", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAddOnDump", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnDump parse(XMLStreamReader reader) throws Exception {
			GetAddOnDump object = new GetAddOnDump();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnDump".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAddOnDump) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
