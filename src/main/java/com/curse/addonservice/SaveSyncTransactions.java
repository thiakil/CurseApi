...
public class SaveSyncTransactions implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SaveSyncTransactions", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SaveSyncTransactions", xmlWriter);
			}
		}
		...
		if (localTransactionsTracker) {
			if (localTransactions == null) {
				...
				localTransactions.serialize(new QName(
								"http://addonservice.curse.com/", "transactions"),
						xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static SaveSyncTransactions parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SaveSyncTransactions".equals(type)) {
							...
							return (SaveSyncTransactions) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "instanceID").equals(
								reader.getName())) {
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "transactions").equals(
								reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
							"nil");
					...
					if ("true".equals(nillableValue) ||
						...
						object.setTransactions(ArrayOfSyncTransaction.Factory.parse(
								reader));
