...
public class ResetFeeds implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":ResetFeeds", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"ResetFeeds", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static ResetFeeds parse(XMLStreamReader reader)
				throws Exception {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"ResetFeeds".equals(type)) {
							...
							return (ResetFeeds) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
