...
public class GetSyncProfile implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetSyncProfile", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetSyncProfile", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetSyncProfile parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetSyncProfile".equals(type)) {
							...
							return (GetSyncProfile) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
