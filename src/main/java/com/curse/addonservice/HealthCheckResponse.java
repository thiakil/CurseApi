...
public class HealthCheckResponse implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":HealthCheckResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"HealthCheckResponse", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static HealthCheckResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"HealthCheckResponse".equals(type)) {
							...
							return (HealthCheckResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"HealthCheckResult").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) &&
						...
						object.setHealthCheckResult(ConverterUtil.convertToString(
								content));
					} else {
