...
/**
 * HealthCheckResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class HealthCheckResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "HealthCheckResponse", "ns9");
	private static final QName healthCheckResultQName = new QName("http://addonservice.curse.com/", "HealthCheckResult");

	/**
	 * field for HealthCheckResult
	 */
	protected String localHealthCheckResult;
	...
	public String getHealthCheckResult() {
		return localHealthCheckResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param HealthCheckResult
	 */
	public void setHealthCheckResult(String param) {
		localHealthCheckResultTracker = true;

		this.localHealthCheckResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":HealthCheckResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "HealthCheckResponse", xmlWriter);
			}
		}

		if (localHealthCheckResultTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "HealthCheckResult", xmlWriter);

			if (localHealthCheckResult == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localHealthCheckResult);
			}
	...
	public static class Factory {
		 ...
		 */
		public static HealthCheckResponse parse(XMLStreamReader reader) throws Exception {
			HealthCheckResponse object = new HealthCheckResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"HealthCheckResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (HealthCheckResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && healthCheckResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						String content = reader.getElementText();

						object.setHealthCheckResult(ConverterUtil.convertToString(content));
					} else {
