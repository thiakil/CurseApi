...
public class GetFuzzyMatches implements ADBBean {
	 ...
	 */
	public void setFolderFingerprints(ArrayOfFolderFingerprint param) {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetFuzzyMatches", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetFuzzyMatches", xmlWriter);
			}
		}
		...
		if (localFolderFingerprintsTracker) {
			if (localFolderFingerprints == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "folderFingerprints", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static GetFuzzyMatches parse(XMLStreamReader reader) throws Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetFuzzyMatches".equals(type)) {
							...
							return (GetFuzzyMatches) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && new QName("http://addonservice.curse.com/", "folderFingerprints").equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setFolderFingerprints(ArrayOfFolderFingerprint.Factory.parse(reader));
