...
public class GetFingerprintMatches implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetFingerprintMatches", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetFingerprintMatches", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetFingerprintMatches parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetFingerprintMatches".equals(type)) {
							...
							return (GetFingerprintMatches) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
