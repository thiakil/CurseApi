...
/**
 * GetFingerprintMatches bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetFingerprintMatches implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetFingerprintMatches", "ns9");
	...
	public GetFingerprintMatches() {
	}

	public GetFingerprintMatches(ArrayOflong fingerprints) {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetFingerprintMatches", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetFingerprintMatches", xmlWriter);
			}
		}

		if (localFingerprintsTracker) {
			if (localFingerprints == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "fingerprints", xmlWriter);
	...
	public static class Factory {
		 ...
		 */
		public static GetFingerprintMatches parse(XMLStreamReader reader) throws Exception {
			GetFingerprintMatches object = new GetFingerprintMatches();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetFingerprintMatches".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetFingerprintMatches) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && new QName("http://addonservice.curse.com/", "fingerprints").equals(reader.getName())) {
