...
/**
 * GetAddOnDescriptionResponse.java
 * <p>
...
/**
 * GetAddOnDescriptionResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetAddOnDescriptionResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetAddOnDescriptionResponse", "ns9");
	private static final QName getAddOnDescriptionResultQName = new QName("http://addonservice.curse.com/", "GetAddOnDescriptionResult");

	/**
	 * field for GetAddOnDescriptionResult
	 */
	protected String localGetAddOnDescriptionResult;
	 ...
	 */
	public String getGetAddOnDescriptionResult() {
		return localGetAddOnDescriptionResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param GetAddOnDescriptionResult
	 */
	public void setGetAddOnDescriptionResult(String param) {
		localGetAddOnDescriptionResultTracker = true;

		this.localGetAddOnDescriptionResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAddOnDescriptionResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAddOnDescriptionResponse", xmlWriter);
			}
		}

		if (localGetAddOnDescriptionResultTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "GetAddOnDescriptionResult", xmlWriter);

			if (localGetAddOnDescriptionResult == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localGetAddOnDescriptionResult);
			}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnDescriptionResponse parse(XMLStreamReader reader) throws Exception {
			GetAddOnDescriptionResponse object = new GetAddOnDescriptionResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnDescriptionResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAddOnDescriptionResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && getAddOnDescriptionResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						String content = reader.getElementText();

						object.setGetAddOnDescriptionResult(ConverterUtil.convertToString(content));
					} else {
