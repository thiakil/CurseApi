...
/**
 * GetRepositoryMatchFromSlug.java
 * <p>
...
/**
 * GetRepositoryMatchFromSlug bean class
 */
...
public class GetRepositoryMatchFromSlug implements ADBBean {
	 ...
	 * field for GameSlug
	 */
	protected String localGameSlug;

	/*  This tracker boolean wil be used to detect whether the user called the set method
	 *   for this attribute. It will be used to determine whether to include this field
	 *   in the serialized XML
	 */
	protected boolean localGameSlugTracker = false;

	/**
	 * field for AddonSlug
	 */
	protected String localAddonSlug;
	...
	public String getGameSlug() {
		return localGameSlug;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param GameSlug
	 */
	public void setGameSlug(String param) {
		localGameSlugTracker = true;

		this.localGameSlug = param;
	}

	public boolean isAddonSlugSpecified() {
		return localAddonSlugTracker;
	}
	...
	public String getAddonSlug() {
		return localAddonSlug;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param AddonSlug
	 */
	public void setAddonSlug(String param) {
		localAddonSlugTracker = true;

		this.localAddonSlug = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetRepositoryMatchFromSlug", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetRepositoryMatchFromSlug", xmlWriter);
			}
		}

		if (localGameSlugTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "gameSlug", xmlWriter);

			if (localGameSlug == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localGameSlug);
			}

			xmlWriter.writeEndElement();
		}

		if (localAddonSlugTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "addonSlug", xmlWriter);

			if (localAddonSlug == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localAddonSlug);
			}
	...
	public static class Factory {
		 ...
		 */
		public static GetRepositoryMatchFromSlug parse(XMLStreamReader reader) throws Exception {
			GetRepositoryMatchFromSlug object = new GetRepositoryMatchFromSlug();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetRepositoryMatchFromSlug".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetRepositoryMatchFromSlug) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && new QName("http://addonservice.curse.com/", "gameSlug").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setGameSlug(ConverterUtil.convertToString(content));
					} else {
				...
				if (reader.isStartElement() && new QName("http://addonservice.curse.com/", "addonSlug").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setAddonSlug(ConverterUtil.convertToString(content));
					} else {
						reader.getElementText(); // throw away text nodes if any.
					}
