...
public class JoinSyncGroup implements ADBBean {
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":JoinSyncGroup", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "JoinSyncGroup", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static JoinSyncGroup parse(XMLStreamReader reader) throws Exception {
			JoinSyncGroup object = new JoinSyncGroup();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"JoinSyncGroup".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (JoinSyncGroup) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
