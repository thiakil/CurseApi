...
public class JoinSyncGroup implements ADBBean {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":JoinSyncGroup", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"JoinSyncGroup", xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static JoinSyncGroup parse(
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"JoinSyncGroup".equals(type)) {
							...
							return (JoinSyncGroup) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
