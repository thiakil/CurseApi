...
/**
 * LeaveSyncGroupResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class LeaveSyncGroupResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "LeaveSyncGroupResponse", "ns9");
	private static final QName leaveSyncGroupResultQName = new QName("http://addonservice.curse.com/", "LeaveSyncGroupResult");

	/**
	 * field for LeaveSyncGroupResult
	 */
	protected ServiceResponse localLeaveSyncGroupResult;
	 ...
	 */
	public ServiceResponse getLeaveSyncGroupResult() {
		return localLeaveSyncGroupResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param LeaveSyncGroupResult
	 */
	public void setLeaveSyncGroupResult(ServiceResponse param) {
		localLeaveSyncGroupResultTracker = true;

		this.localLeaveSyncGroupResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":LeaveSyncGroupResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "LeaveSyncGroupResponse", xmlWriter);
			}
		}

		if (localLeaveSyncGroupResultTracker) {
			if (localLeaveSyncGroupResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "LeaveSyncGroupResult", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localLeaveSyncGroupResult.serialize(leaveSyncGroupResultQName, xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static LeaveSyncGroupResponse parse(XMLStreamReader reader) throws Exception {
			LeaveSyncGroupResponse object = new LeaveSyncGroupResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"LeaveSyncGroupResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (LeaveSyncGroupResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && leaveSyncGroupResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setLeaveSyncGroupResult(null);
						reader.next();

						reader.next();
					} else {
						object.setLeaveSyncGroupResult(ServiceResponse.Factory.parse(reader));
