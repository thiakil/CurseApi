...
/**
 * GetAddOnResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetAddOnResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetAddOnResponse", "ns9");
	private static final QName getAddOnResultQName = new QName("http://addonservice.curse.com/", "GetAddOnResult");

	/**
	 * field for GetAddOnResult
	 */
	protected AddOn localGetAddOnResult;
	 ...
	 *
	 * @return addons.curse.AddOn
	 */
	public AddOn getGetAddOnResult() {
		return localGetAddOnResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param GetAddOnResult
	 */
	public void setGetAddOnResult(AddOn param) {
		localGetAddOnResultTracker = true;

		this.localGetAddOnResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAddOnResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAddOnResponse", xmlWriter);
			}
		}

		if (localGetAddOnResultTracker) {
			if (localGetAddOnResult == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "GetAddOnResult", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				localGetAddOnResult.serialize(getAddOnResultQName, xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOnResponse parse(XMLStreamReader reader) throws Exception {
			GetAddOnResponse object = new GetAddOnResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOnResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAddOnResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && getAddOnResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						object.setGetAddOnResult(null);
						reader.next();

						reader.next();
					} else {
						object.setGetAddOnResult(AddOn.Factory.parse(reader));
