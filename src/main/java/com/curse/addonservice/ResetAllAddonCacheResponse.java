...
/**
 * ResetAllAddonCacheResponse.java
 * <p>
...
/**
 * ResetAllAddonCacheResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class ResetAllAddonCacheResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "ResetAllAddonCacheResponse", "ns9");
	private static final QName resetAllAddonCacheResultQName = new QName("http://addonservice.curse.com/", "ResetAllAddonCacheResult");

	/**
	 * field for ResetAllAddonCacheResult
	 */
	protected String localResetAllAddonCacheResult;
	 ...
	 */
	public String getResetAllAddonCacheResult() {
		return localResetAllAddonCacheResult;
	}

	/**
	 * Auto generated setter method
	 *
	 * @param param ResetAllAddonCacheResult
	 */
	public void setResetAllAddonCacheResult(String param) {
		localResetAllAddonCacheResultTracker = true;

		this.localResetAllAddonCacheResult = param;
	}
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ResetAllAddonCacheResponse", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ResetAllAddonCacheResponse", xmlWriter);
			}
		}

		if (localResetAllAddonCacheResultTracker) {
			namespace = "http://addonservice.curse.com/";
			Util.writeStartElement(null, namespace, "ResetAllAddonCacheResult", xmlWriter);

			if (localResetAllAddonCacheResult == null) {
				// write the nil attribute
				Util.writeNil(xmlWriter);
			} else {
				xmlWriter.writeCharacters(localResetAllAddonCacheResult);
			}
	...
	public static class Factory {
		 ...
		 */
		public static ResetAllAddonCacheResponse parse(XMLStreamReader reader) throws Exception {
			ResetAllAddonCacheResponse object = new ResetAllAddonCacheResponse();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ResetAllAddonCacheResponse".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (ResetAllAddonCacheResponse) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && resetAllAddonCacheResultQName.equals(reader.getName())) {
					nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");

					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						String content = reader.getElementText();

						object.setResetAllAddonCacheResult(ConverterUtil.convertToString(content));
					} else {
