...
public class SaveSyncTransactionsResponse implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/",
			"SaveSyncTransactionsResponse", "ns9");
	 ...
	 */
	public void setSaveSyncTransactionsResult(
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":SaveSyncTransactionsResponse", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"SaveSyncTransactionsResponse", xmlWriter);
			}
		}
		...
		if (localSaveSyncTransactionsResultTracker) {
			if (localSaveSyncTransactionsResult == null) {
				writeStartElement(null, "http://addonservice.curse.com/",
						"SaveSyncTransactionsResult", xmlWriter);
				...
				localSaveSyncTransactionsResult.serialize(new QName(
						"http://addonservice.curse.com/",
						"SaveSyncTransactionsResult"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static SaveSyncTransactionsResponse parse(
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"SaveSyncTransactionsResponse".equals(type)) {
							...
							return (SaveSyncTransactionsResponse) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/",
								"SaveSyncTransactionsResult").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setSaveSyncTransactionsResult(ServiceResponse.Factory.parse(
								reader));
