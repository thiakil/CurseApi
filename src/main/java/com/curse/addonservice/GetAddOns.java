...
public class GetAddOns implements ADBBean {
	...
	public void serialize(final QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":GetAddOns", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"GetAddOns", xmlWriter);
		...
		if (localIdsTracker) {
			if (localIds == null) {
				...
				localIds.serialize(new QName(
						"http://addonservice.curse.com/", "ids"), xmlWriter);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOns parse(XMLStreamReader reader)
				throws Exception {
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOns".equals(type)) {
							...
							return (GetAddOns) ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() &&
						new QName(
								"http://addonservice.curse.com/", "ids").equals(
								reader.getName())) {
					...
					if ("true".equals(nillableValue) ||
						...
						object.setIds(ArrayOfint.Factory.parse(
								reader));
