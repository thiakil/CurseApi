...
/**
 * GetAddOns bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class GetAddOns implements ADBBean {
	public static final QName MY_QNAME = new QName("http://addonservice.curse.com/", "GetAddOns", "ns9");
	private static final QName idsQName = new QName("http://addonservice.curse.com/", "ids");
	...
	public void serialize(final QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":GetAddOns", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "GetAddOns", xmlWriter);
			}
		}

		if (localIdsTracker) {
			if (localIds == null) {
				Util.writeStartElement(null, "http://addonservice.curse.com/", "ids", xmlWriter);

				// write the nil attribute
				Util.writeNil(xmlWriter);
				xmlWriter.writeEndElement();
			} else {
				ArrayOfint.serialize(idsQName, xmlWriter, localIds);
			}
		}
	...
	public static class Factory {
		 ...
		 */
		public static GetAddOns parse(XMLStreamReader reader) throws Exception {
			GetAddOns object = new GetAddOns();
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"GetAddOns".equals(type)) {
							//find namespace for the prefix
							String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);

							return (GetAddOns) ExtensionMapper.getTypeObject(nsUri, type, reader);
						}
					}
				}
				...
				if (reader.isStartElement() && idsQName.equals(reader.getName())) {
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setIds(ArrayOfint.Factory.parse(reader));
