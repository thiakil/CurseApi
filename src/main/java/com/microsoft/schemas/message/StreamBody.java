...
public class StreamBody implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.microsoft.com/Message",
			"StreamBody", "ns8");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) &&
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":StreamBody", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"StreamBody", xmlWriter);
			}
		}

		if (localStreamBody == null) {
			throw new ADBException(
					"StreamBody cannot be null !!");
		} else {
	...
	public static class Factory {
		...
		public static StreamBody fromString(String value,
											String namespaceURI) {
			StreamBody returnValue = new StreamBody();

			returnValue.setStreamBody(ConverterUtil.convertToBase64Binary(
					value));

			return returnValue;
		}

		public static StreamBody fromString(
		 ...
		 */
		public static StreamBody parse(XMLStreamReader reader)
				throws Exception {
					...
					if (reader.isStartElement() || reader.hasText()) {
						if (reader.isStartElement() || reader.hasText()) {
							...
							if ("true".equals(nillableValue) ||
								...
								throw new ADBException(
										"The element: " + "StreamBody" +
												"  cannot be null");
							}

							String content = reader.getElementText();

							object.setStreamBody(ConverterUtil.convertToBase64Binary(
									content));
