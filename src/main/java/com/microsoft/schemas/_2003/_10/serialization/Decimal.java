...
public class Decimal implements ADBBean {
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "decimal", "ns2");
	 ...
	 * @param param Decimal
	 */
	public void setDecimal(BigDecimal param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":decimal", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "decimal", xmlWriter);
			}
		}
		...
		if (localDecimal == null) {
			...
			xmlWriter.writeCharacters(ConverterUtil.convertToString(localDecimal));
		}
	...
	public static class Factory {
		 ...
		 */
		public static Decimal parse(XMLStreamReader reader) throws Exception {
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "decimal").equals(reader.getName())) {
							...
							if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
								...
								object.setDecimal(ConverterUtil.convertToDecimal(content));
							} else {
