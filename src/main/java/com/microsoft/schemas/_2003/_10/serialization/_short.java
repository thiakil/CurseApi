...
public class _short implements ADBBean {
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "short", "ns2");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":short", xmlWriter);
			} else {
				Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "short", xmlWriter);
			}
		}
		...
		if (local_short == Short.MIN_VALUE) {
			...
			xmlWriter.writeCharacters(ConverterUtil.convertToString(local_short));
		}
	...
	public static class Factory {
		 ...
		 */
		public static _short parse(XMLStreamReader reader) throws Exception {
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "short").equals(reader.getName())) {
							...
							if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
								...
								object.set_short(ConverterUtil.convertToShort(content));
							} else {
								object.set_short(Short.MIN_VALUE);
