...
public class Base64Binary implements ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (localBase64Binary == null) {
			...
			if (localBase64Binary != null) {
				try {
					XMLStreamWriterUtils.writeDataHandler(xmlWriter,
							localBase64Binary, null, true);
				} catch (IOException ex) {
					throw new XMLStreamException("Unable to read data handler for base64Binary",
							ex);
				}
			}
		}
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
							...
							if ("true".equals(nillableValue) ||
								...
								object.setBase64Binary(XMLStreamReaderUtils.getDataHandlerFromElement(
										reader));
							}
