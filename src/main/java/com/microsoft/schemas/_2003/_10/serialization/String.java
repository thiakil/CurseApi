...
public class String implements ADBBean {
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "string", "ns2");
	...
	public static class Factory {
		 ...
		 */
		public static String parse(XMLStreamReader reader) throws Exception {
					...
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "string").equals(reader.getName())) {
							...
							if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
								...
								object.setString(ConverterUtil.convertToString(content));
							} else {
