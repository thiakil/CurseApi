...
public class ArrayOfintE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays", "ArrayOfint", "ns3");
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfintE parse(XMLStreamReader reader) throws Exception {
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays", "ArrayOfint").equals(reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
