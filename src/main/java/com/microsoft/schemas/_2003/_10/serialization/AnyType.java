...
public class AnyType implements ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (localAnyType instanceof ADBBean) {
			((ADBBean) localAnyType).serialize(MY_QNAME,
					xmlWriter, true);
		} else {
			...
			if (localAnyType == null) {
				...
				ConverterUtil.serializeAnyType(localAnyType,
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 */
		public static AnyType parse(XMLStreamReader reader)
				throws Exception {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() &&
							...
							object.setAnyType(ConverterUtil.getAnyTypeObject(
									reader,
