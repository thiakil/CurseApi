...
public class AnyType implements ADBBean {
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "anyType", "ns2");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, XMLStreamWriter xmlWriter, boolean serializeType) throws XMLStreamException {
		...
		if (localAnyType instanceof ADBBean) {
			((ADBBean) localAnyType).serialize(MY_QNAME, xmlWriter, true);
		} else {
			String namespace = "http://schemas.microsoft.com/2003/10/Serialization/";
			String _localName = "anyType";
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":anyType", xmlWriter);
				} else {
					Util.writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "anyType", xmlWriter);
				}
			}
			...
			if (localAnyType == null) {
				...
				ConverterUtil.serializeAnyType(localAnyType, xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 */
		public static AnyType parse(XMLStreamReader reader) throws Exception {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/", "anyType").equals(reader.getName())) {
							object.setAnyType(ConverterUtil.getAnyTypeObject(reader, ExtensionMapper.class));
