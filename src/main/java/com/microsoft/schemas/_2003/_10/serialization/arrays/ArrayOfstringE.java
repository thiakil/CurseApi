...
public class ArrayOfstringE implements ADBBean {
	public static final QName MY_QNAME = new QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays", "ArrayOfstring", "ns3");
	...
	public static class Factory {
		 ...
		 */
		public static ArrayOfstringE parse(XMLStreamReader reader) throws Exception {
			...
			try {
				...
				while (!reader.isEndElement()) {
					if (reader.isStartElement()) {
						if (reader.isStartElement() && new QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays", "ArrayOfstring").equals(reader.getName())) {
							nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
